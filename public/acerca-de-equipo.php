<?php
$page_title = 'Acerca del Equipo - Carpoolear';
$body_class = 'body-acerca acerca-de-equipo'; 
                        ...
                        <div class="col-sm-12 pt48">
                            ...
                            <div class="row">
                             <div class="col-sm-10 col-sm-8-offset-1">
                                ...
                                <p><strong>Colaboradores</strong>: Gonzalo González Mora, Carmen García, Barbara Cravero, Andrés Kulacio, Gerardo Torj, Germán Gentile, Luciana Bernard</p>

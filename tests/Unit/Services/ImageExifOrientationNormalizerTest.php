...
class ImageExifOrientationNormalizerTest extends TestCase
{
    ...
    public function test_normalize_corrects_exif_orientation_6_by_rotating_pixels(): void
    {
        if (! class_exists(\Imagick::class)) {
            $this->markTestSkipped('Imagick required to build oriented JPEG fixture.');
        }

        $orientedJpeg = $this->createJpegWithExifOrientation(100, 200, \Imagick::ORIENTATION_RIGHTTOP);

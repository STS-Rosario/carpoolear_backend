...
## `DevCurlHttpClient` (`app/Services/HttpClients/DevCurlHttpClient.php`)

- **Cause:** **`RemoveMethodCall`** on **`parent::openConnection`**, **`RemoveArrayItem`** / **`ForeachEmptyIterable`** on **`$possibleProperties`** / loop (`c4d5a15b8a3b9b64`, `3fd689931df6fd02`, `f356850df2d12ba3`, `507e14b5d7f7de03`, `c28331bdd2eef7d0`, `59c05aa3ec194ad9`).
- **Fix:** **`tests/Unit/Services/HttpClients/DevCurlHttpClientTest::test_open_connection_runs_parent_and_property_probe_without_throwing`** (skipped when **`Facebook\HttpClients\FacebookCurlHttpClient`** is absent).

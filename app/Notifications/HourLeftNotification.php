...
class HourLeftNotification extends BaseNotification
{
    ...
    {
        return 'Falta un poco más de una hora para le viaje hacia ' . $this->getAttribute('trip')->to_town;
    }
    ...
    public function toPush($user, $device)
    {
        ...
        return [
            'message' => "Recuerada que en un poco más de una hora viajas hacia ".$trip->to_town,
            'url' => 'trip',
            'extras' => [
                'id' => $trip->id,
            ],
